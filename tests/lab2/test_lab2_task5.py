...
source = Path(__file__).resolve().parents[2] / "Lab2" / "task5" / "src" / "lab.py"
spec = importlib.util.spec_from_file_location("lab2_task5", source)
...
class CounterTests(unittest.TestCase):
    ...
    def test_three_threads(self):
        self.assertEqual(lab.run_threads(3, 10), 10)
